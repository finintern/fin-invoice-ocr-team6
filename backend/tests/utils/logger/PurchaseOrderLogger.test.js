...
describe('PurchaseOrderLogger', () => {
  ...
  describe('Get By ID Logging', () => {
    it('should log get by id request', () => {
      const purchaseOrderId = 'po12345';
      
      instance.logGetByIdRequest(purchaseOrderId);
    ...
    it('should log get by id success', () => {
      const purchaseOrderId = 'po12345';
      
      instance.logGetByIdSuccess(purchaseOrderId);
    ...
    it('should log get by id not found', () => {
      const purchaseOrderId = 'po12345';
      
      instance.logGetByIdNotFound(purchaseOrderId);
    ...
    it('should log get by id error with complete error object', () => {
      const purchaseOrderId = 'po12345';
      const error = new Error('Database connection failed');
      error.code = 'DB_CONN_ERROR';
      error.name = 'DatabaseError';
      
      instance.logGetByIdError(purchaseOrderId, error);
    ...
    it('should log get by id error with null error object', () => {
      const purchaseOrderId = 'po12345';
      
      instance.logGetByIdError(purchaseOrderId, null);
